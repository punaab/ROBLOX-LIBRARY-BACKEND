...
router.post('/api/books', async (req, res) => {
  try {
    ...
    const updateDoc = {
      ...
      genres: genres || [], // Ensure genres is saved
      status: 'Draft',
      published: false,
...
// // Example: In your server-side route for SaveBook
// router.post('/saveBook', async (req, res) => {
//   const { bookId, title, content, playerId, author, coverId, genres } = req.body;
//   try {
...
//         author,
//         coverId,
//         genres, // Ensure genres is updated
//         updatedAt: new Date().toISOString(),
//       },
//       { upsert: true, new: true }
//     );
